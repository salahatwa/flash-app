...
import { CustomHttpUrlEncodingCodec, Task } from '../models/models';
...
export class TaskService {
   ...
   */
  public getAllUserTasks(pageNo?: number, pageSize?: number, sortBy?: string): Observable<any> {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public saveTask(taskDto: Task): Observable<Task> {
